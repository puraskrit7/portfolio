    ...
    <section id="about" className="scroll-mt-28">
      <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
        ...
        >
          ...
          >
            <img
              src={`${import.meta.env.BASE_URL}puraskrit.png`}
              alt="Puraskrit"
            ...
            <div className="space-y-5 p-5">
              ...
              <div className="grid grid-cols-2 gap-3 border-b border-border pb-5">
                ...
                <div>
                  ...
                  <div className="font-display text-lg text-ink">
                    {profile.activeUsersServed}
                  </div>
                </div>
              </div>

              <div className="border-b border-border pb-5">
                <div className="mb-3 font-mono text-[10px] uppercase tracking-[0.25em] text-faint">
                  Core Proficiencies
                </div>
              ...
              <div className="space-y-2 border-b border-border pb-5">
                <div className="mb-1 font-mono text-[10px] uppercase tracking-[0.25em] text-faint">
                  Domain Experience
                </div>
                {domains.map((d) => (
        ...
        >
          <motion.h1
            variants={item}
            className="font-display text-4xl font-medium leading-[1.08] tracking-tight text-ink sm:text-5xl"
          >
            {profile.name} builds
            <br />
          ...
          <motion.div
            variants={item}
            className="mt-8 grid max-w-md grid-cols-3 gap-4 border-y border-border py-6"
          >
            <div>
