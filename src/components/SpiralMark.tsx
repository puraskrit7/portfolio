...
/** An original spiral motif (Archimedean swirl) — not any franchise's logo or artwork. */
export default function SpiralMark({ size = 24, className = '', spinClass = 'animate-spin-slower' }: Props) {
  return (
    <svg
      width={size}
      height={size}
